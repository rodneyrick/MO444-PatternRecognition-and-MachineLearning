...
val <- read.csv(file="D:\\MO444\\2015s2-mo444-assignment-04\\trat_200.csv", sep=",", header = FALSE, nrows=20000, skip = 25000)
...
# original data
pca <- princomp(fft_train[,-1]) # principal components analysis using correlation matrix
pc.comp <- pca$scores
