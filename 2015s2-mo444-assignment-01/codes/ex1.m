...
final_error_exact = (y_exact-y_original)/rows(y);
...
csvwrite('D:\\MO444\\2015s2-mo444-assignment-01\\y_original_exact.csv', [y_original,y_exact]);

final_error_exact = (y_exact-y_original)/rows(final_error_exact);
mean_error_exact = mean(abs(final_error_exact));
